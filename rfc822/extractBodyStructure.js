...
const createEnvelope = require('./getEnvelope')
...
class BodyStructure {
     ...
     *
     * @param {Object} node A node of the MimeTree
...
// Returns the BODYSTRUCTURE value of the email as defined in rfc3501 section 7.4.2
// For formatted examples please check: http://sgerwk.altervista.org/imapbodystructure.html
// It takes the MimeTree object as an argument and returns the body structure represented as nested arrays
// For example: 
/**
 * The following array represented BODYSTRUCTURE
 * [
 *  ["TEXT", "PLAIN", ["CHARSET", "iso-8859-1"], null, null, "QUOTED-PRINTABLE," 2234, 63, null, null, null, null],
 *  ["TEXT", "HTML", ["CHARSET", "iso-8859-1"], null, null, "QUOTED-PRINTABLE," 2234, 63, null, null, null, null],
 *  "ALTERNATIVE",
 ...
 * ]
 * 
 * corresponds to the following IMAP Fetch response
 ...
 */
const getBodyStructure = function (mimeTree) {
    // full BODYSTRUCTURE
